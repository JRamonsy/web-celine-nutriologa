...
const Footer = () => {
  return (
    <div className="w-full h-auto bg-[#EA580C] flex flex-col items-center gap-2 py-2 ">
      <div className="w-[130px] h-[95px] md:w-[250px] md:h-[180px] xl:w-[300px] xl:h-[220px] bg-[url(/imgs/logo-footer-white.jpg)] bg-cover bg-center xl:bg-cover xl-bg-center " >
      </div>
      ...
      <h2 className=" font-descriptive font-bold text-white text-lg md:text-2xl xl:text-3xl" >2025-Derechos reservador</h2>
      <div className="flex items-center" >
        <h2 className=" font-descriptive font-bold text-white text-lg md:text-2xl xl:text-3xl" >Diseñado por: RS Studio</h2>
