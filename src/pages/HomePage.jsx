...
const HomePage = () => {
  return (
    <header className="flex flex-col items-center ">
      <div 
      className="bg-[url(/imgs/img-home.jpg)] w-full h-[500px] bg-cover bg-center bg-no-repeat flex flex-col items-center  justify-center
      md:h-[1000px]
      ...
      >
        ...
        <div className=" ">
          <button className="bg-red-400 text-white rounded-[15px] py-1 px-3 cursor-pointer mr-1 md:mr-2 hover:bg-red-500 border border-white/20 transition duration-300 shadow-md md:text-2xl " >
          ...
          <div>
            <section className="w-full h-[250px] bg-red-600 rounded-[20px] flex flex-col justify-center items-center shadow-[0_4px_20px_rgba(0,0,0,0.15)]  " >
              <div className="w-full flex justify-center gap-x-2 mb-2">
                ...
                <h2 className=" font-home text-5xl " >
                  Sociales
                </h2>
              </div>
      ...
      <section className="w-full h-[200px] md:h-[250px] bg-red-600 rounded-b-[20px] flex flex-col justify-center items-center shadow-[0_4px_20px_rgba(0,0,0,0.15)] xl:hidden " >
        <div className="w-full flex justify-center gap-x-2 mb-2">
          ...
          <h2 className="text-3xl font-home md:text-5xl " >
            Sociales
          </h2>
        </div>
        <div className="w-full flex justify-around ">
      ...
      <section className=" bg-white w-[95%] h-[300px] md:h-[400px] xl:h-[750px] flex flex-col justify-center item-center my-4 rounded-[15px] shadow-[0_4px_20px_rgba(0,0,0,0.15)] ">
        ...
        <div className="flex" >
          ...
          <ul className=" w-[65%] xl:w-[50%] h-[250px] xl:h-[600px] md:h-[350px]  text-xl md:text-2xl xl:text-4xl flex justify-center flex-col gap-5 md:gap-14 xl:gap-25  xl:pl-15   ">
      ...
      <section className="w-[95%] h-[455px] md:h-[390px] xl:h-[500px] bg-gray-200 rounded-[10px] flex flex-col items-center rounded-[15px] shadow-[0_4px_20px_rgba(0,0,0,0.15)] ">
        ...
        <ul className="text-lg xl:text-2xl md:text-xl flex flex-col justify-center gap-1 bg-white w-[95%] md:w-[90%] xl:w-[50%] md:px-5 xl:py-5 rounded-[15px] " >
      ...
      <section className="w-[95%] h-[600px] md:h-auto xl:h-[650px] bg-white rounded-[15px] flex flex-col items-center my-4 shadow-[0_4px_20px_rgba(0,0,0,0.15)] ">
        ...
        <section className="w-[80%]  ">
          <h2 className="text-center md:text-xl font-bold xl:text-2xl ">Te presento mis planes de alimentación con los cuáles podrás lograr grandes resultados</h2>
        </section>
        <ul className="flex flex-col text-lg md:text-xl xl:text-2xl w-[90%] xl:w-[55%] ">
