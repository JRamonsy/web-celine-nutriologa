      ...
      <section className="w-[95%] " >
        ...
        <div className="w-full flex flex-col items-center xl:flex-row " >
          ...
          <div className="xl:flex xl:flex-col xl:w-full  " >
            <h2 className='text-white font-bold text-xl md:text-2xl bg-[rgba(254,64,52,1)] rounded-t-[25px]  py-1  text-center'>NUTRICIÓN CLÍNICA</h2>
            <div className='bg-white w-full h-auto rounded-b-[25px] p-2 shadow-[0_4px_20px_rgba(0,0,0,0.15)] md:text-lg xl:text-2xl ' >
              <h3>
        ...
        <div className="w-full flex flex-col items-center xl:flex-row " >
          ...
          <div className="xl:flex xl:flex-col xl:w-full order-2 xl:order-1 " >
            <h2 className='text-white font-bold text-xl md:text-2xl bg-[rgba(254,64,52,1)] rounded-t-[25px]  py-1  text-center'>CONTROL DE PESO</h2>
            <div className='bg-white w-full h-auto rounded-b-[25px] p-2 shadow-[0_4px_20px_rgba(0,0,0,0.15)] md:text-lg xl:text-2xl ' >
              <h3>
        ...
        <div className="w-full flex flex-col items-center xl:flex-row " >
          ...
          <div className="xl:flex xl:flex-col xl:w-full " >
            <h2 className='text-white font-bold text-xl md:text-2xl bg-[rgba(254,64,52,1)] rounded-t-[25px]  py-1  text-center'>EDUCACÍON EN DIABETES</h2>
            <div className='bg-white w-full h-auto rounded-b-[25px] p-2 shadow-[0_4px_20px_rgba(0,0,0,0.15)] md:text-lg xl:text-2xl ' >
              <h3>
        ...
        <div className="w-full flex flex-col items-center xl:flex-row " >
          ...
          <div className="xl:flex xl:flex-col xl:w-full order-2 xl:order-1" >
            <h2 className='text-white font-bold text-xl md:text-2xl bg-[rgba(254,64,52,1)] rounded-t-[25px]  py-1  text-center'>ALIMENTACÍON VEGETARIANA</h2>
            <div className='bg-white w-full h-auto rounded-b-[25px] p-2 shadow-[0_4px_20px_rgba(0,0,0,0.15)] md:text-lg xl:text-2xl ' >
              <h3>
