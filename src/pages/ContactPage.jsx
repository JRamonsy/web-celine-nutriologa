  ...
  return (
    <div className="w-full flex flex-col items-center" >
      ...
      <section className="w-[95%] bg-slate-200 rounded py-2 px-3 " >
        <div >
          <h3 className="text-xl md:text-2xl xl:text-3xl font-bold text-center " >
        ...
        <div className="my-5 xl:flex   " >
          <div className="order-1 xl:order-2 xl:flex xl:items-center " >
            <h3 className="font-bold text-center md:text-lg xl:text-xl " >Mariano Arista #1085, Colonia tequisquiapan, SLP.</h3>
          </div>
        ...
        <div className="my-5 xl:flex " >
          <div className="xl:flex xl:items-center" >
            <h3 className="font-bold text-center md:text-lg xl:text-xl " >Monterrey #25, Santa Barbara, Villa de Pozos, SLP.Monterrey #25, Santa Barbara, Villa de Pozos, SLP.</h3>
          </div>
      ...
      <section className="w-[95%] flex flex-col items-center my-5 px-3 " >
      ...
      <section className="flex flex-col items-center my-3" >
        ...
        <h2 className="font-bold md:text-2xl xl:text-3xl " >NOS VEMOS PRONTO</h2>
      </section>
